...
public class Authors extends javax.swing.JFrame {
    ...
    public Authors() {
        ...
        String[] data = new String[l.getAuthors().size()];
        if (l.getAuthors().size() != 0) {
            for (int i = 0; i < l.getAuthors().size(); i++) {
                data[i] = l.getAuthors().get(i).getName();
            }

        } else {
            this.msg.setText("No Authors found");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (dialogButton == JOptionPane.YES_OPTION) {
            ...
            if (this.list.getSelectedIndex() == -1) {
                this.msg.setText("Please, Select Author to delete");
            } else {
                l.deleteAuthor(this.list.getSelectedIndex());
                this.setVisible(false);
